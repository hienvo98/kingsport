                ...
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-xl-6">
                            ...
                            <input type="text" class="form-control" id="seo_title" placeholder="Enter Name">
                        </div>
                        <div class="col-xl-6">
                            <label for="seo-description" class="form-label">Seo Description</label>
                            <input type="text" class="form-control" id="seo_description" placeholder="Enter Name">
                        </div>
                        <div class="col-xl-6">
                            <label for="seo-keyword" class="form-label">Seo Keyword</label>
                            <input type="text" class="form-control" id="seo_keyword" placeholder="Enter Name">
                        </div>
                        <div class="col-xl-12 blog-images-container">
                            <label for="blog-author-email" class="form-label">Hình ảnh</label>
