                                                ...
                                                <div class="card-body p-0">
                                                    <div class="row gy-3">
                                                        <div class="col-xl-12">
                                                            ...
                                                            <input type="text" class="form-control" name="category_name" id="categories_name" placeholder="Name" required>
                                                        ...
                                                        <div class="col-xl-12">
                                                            ...
                                                            <select class="form-control" name="status" id="categories_status">
                                                        ...
                                                        <div class="col-xl-12">
                                                            ...
                                                            <input type="number" class="form-control" name="ordinal_number" required id="categories_ordinal_number" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
