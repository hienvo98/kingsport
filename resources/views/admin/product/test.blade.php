            ...
            <div class="card custom-card">
                <div class="card-body add-products p-0">
                    <form method="POST" id="form-product" enctype="multipart/form-data"
                                    ...
                                    <div class="card custom-card shadow-none mb-0 border-0">
                                        <div class="card-body p-0">
                                            <div class="row gy-4">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xl-12 product-documents-container p-2">
                                                                ...
                                                                <input type="file" data-ver-color="" id="avatar"
                                                                    name="avatar" data-color="avatar"
                                                        ...
                                                        <div class="card custom-card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="swiper swiper-overflow">
                                                                    <div class="swiper-wrapper" data-slide="avatar">
                                                ...
                                                <div class="col-xl-12" id="addImage" data-asset="{{ asset('') }}">
                        ...
                        <div class="col-xl-12 p-4" id="desc">
