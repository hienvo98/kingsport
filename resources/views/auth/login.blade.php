                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12 mt-0">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="signin-username" name="email" placeholder="User name">
                                </div>
                                <div class="col-xl-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-light" type="button" onclick="togglePasswordVisibility('signin-password')" id="button-addon2"><i class="ri-eye-off-line align-middle"></i></button>
                                    </div>
                                    <div class="mt-2">
                                        <div class="form-check">
