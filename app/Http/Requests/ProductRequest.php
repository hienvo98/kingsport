...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sale_price' => 'integer',
            'avatarThumb'=>'required|image|mimes:jpeg,png,jpg,gif,webp|max:3072',
            'image_color.*' => 'required',
            'image_color.*.*' => 'required|image|mimes:jpeg,png,jpg,gif,webp|max:3072',
