...
class ShowroomCreateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'imageThumb' => 'required|image|mimes:png,jpg,webp,jpeg|max:3072',
            'images*' => 'required|image|mimes:png,jpg,webp,jpeg|max:3072',
    ...
    public function messages()
    {
        return [
            ...
            'imageThumb.required' => 'vui lòng chọn ảnh đại diện cho showroom',
            ...
            'image.*.required'=> 'vui lòng chọn ảnh chi tiết cho showroom',
